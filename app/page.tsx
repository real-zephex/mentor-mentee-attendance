...
import { UserCircle, BookOpen, Calendar } from "lucide-react";
  ...
  return (
    <main className="container mx-auto py-6 px-4 space-y-8">
      ...
      <Tabs defaultValue="students" className="w-full space-y-6">
        ...
        <TabsContent value="students" className="mt-0 border-none p-0 outline-none">
          <StudentTable />
        </TabsContent>
        <TabsContent value="classes" className="mt-0 border-none p-0 outline-none">
          <ManageClasses />
        </TabsContent>
